...
struct mydsp : public base_dsp {
	...
	#define FAUST_FILE_NAME "gate_stereo.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Threshold", fHslider0, -3e+01f, -1.2e+02f, 0.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Attack", fHslider1, 1e+01f, 1e+01f, 1e+04f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Hold", fHslider3, 2e+02f, 1.0f, 1e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Release", fHslider2, 1e+02f, 1.0f, 1e+03f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Threshold, "Threshold", fHslider0, -3e+01f, -1.2e+02f, 0.0f, 0.1f) \
		p(HORIZONTALSLIDER, Attack, "Attack", fHslider1, 1e+01f, 1e+01f, 1e+04f, 1.0f) \
		p(HORIZONTALSLIDER, Hold, "Hold", fHslider3, 2e+02f, 1.0f, 1e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Release, "Release", fHslider2, 1e+02f, 1.0f, 1e+03f, 1.0f) \
