...
struct mydsp : public base_dsp {
	...
	#define FAUST_FILE_NAME "cubic_distortion.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("CUBIC NONLINEARITY cubicnl [tooltip: Reference:                            https://ccrma.stanford.edu/~jos/pasp/Cubic_Soft_Clipper.html]/[1]/Drive", fHslider0, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("CUBIC NONLINEARITY cubicnl [tooltip: Reference:                            https://ccrma.stanford.edu/~jos/pasp/Cubic_Soft_Clipper.html]/[1]/Offset", fHslider1, 0.0f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Drive, "CUBIC NONLINEARITY cubicnl [tooltip: Reference:                            https://ccrma.stanford.edu/~jos/pasp/Cubic_Soft_Clipper.html]/[1]/Drive", fHslider0, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, Offset, "CUBIC NONLINEARITY cubicnl [tooltip: Reference:                            https://ccrma.stanford.edu/~jos/pasp/Cubic_Soft_Clipper.html]/[1]/Offset", fHslider1, 0.0f, 0.0f, 1.0f, 0.01f) \
