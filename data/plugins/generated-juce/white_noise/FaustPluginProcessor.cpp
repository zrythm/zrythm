...
struct mydsp : public base_dsp {
	...
	void metadata(Meta* m) {
		...
		m->declare("description", "White noise generator");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("White Noise");
		ui_interface->declare(&fHslider0, "unit", "dB");
		ui_interface->addHorizontalSlider("Amp", &fHslider0, FAUSTFLOAT(-1e+01f), FAUSTFLOAT(-7e+01f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.1f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp0 = 4.656613e-10f * fRec1[0] * static_cast<float>(iRec0[0]);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp0);
			iRec0[1] = iRec0[0];
			fRec1[1] = fRec1[0];
		}
	}
	...
	#define FAUST_FILE_NAME "white_noise.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Amp", fHslider0, -1e+01f, -7e+01f, 1e+01f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Amp, "Amp", fHslider0, -1e+01f, -7e+01f, 1e+01f, 0.1f) \
