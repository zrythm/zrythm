...
struct mydsp : public base_dsp {
	...
	#define FAUST_FILE_NAME "peak_limiter.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Ratio", fHslider1, 4.0f, 4.0f, 2e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Threshold", fHslider2, -6.0f, -6.0f, 0.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Attack", fHslider0, 8e+02f, 2e+01f, 8e+02f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Release", fHslider3, 5e+02f, 5e+01f, 1.1e+03f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Ratio, "Ratio", fHslider1, 4.0f, 4.0f, 2e+01f, 0.01f) \
		p(HORIZONTALSLIDER, Threshold, "Threshold", fHslider2, -6.0f, -6.0f, 0.0f, 0.1f) \
		p(HORIZONTALSLIDER, Attack, "Attack", fHslider0, 8e+02f, 2e+01f, 8e+02f, 1.0f) \
		p(HORIZONTALSLIDER, Release, "Release", fHslider3, 5e+02f, 5e+01f, 1.1e+03f, 1.0f) \
