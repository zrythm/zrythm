...
struct mydsp : public base_dsp {
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Delay", &fHslider2, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider1, "3", "");
		ui_interface->addHorizontalSlider("Feedback", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = 0.01f * static_cast<float>(fHslider0);
		float fSlow1 = 1.0f - fSlow0;
		float fSlow2 = 0.01f * static_cast<float>(fHslider1);
		float fSlow3 = fConst1 * static_cast<float>(fHslider2);
		float fSlow4 = fConst2 / static_cast<float>(fHslider3);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = static_cast<float>(input0[i0]);
			float fTemp1 = fTemp0 + fSlow2 * fRec0[1];
			fVec0[IOTA0 & 1048575] = fTemp1;
			float fTemp2 = ((fRec1[1] != 0.0f) ? (((fRec2[1] > 0.0f) & (fRec2[1] < 1.0f)) ? fRec1[1] : 0.0f) : (((fRec2[1] == 0.0f) & (fSlow3 != fRec3[1])) ? fSlow4 : (((fRec2[1] == 1.0f) & (fSlow3 != fRec4[1])) ? -fSlow4 : 0.0f)));
			fRec1[0] = fTemp2;
			fRec2[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec2[1] + fTemp2));
			fRec3[0] = (((fRec2[1] >= 1.0f) & (fRec4[1] != fSlow3)) ? fSlow3 : fRec3[1]);
			fRec4[0] = (((fRec2[1] <= 0.0f) & (fRec3[1] != fSlow3)) ? fSlow3 : fRec4[1]);
			int iTemp3 = static_cast<int>(std::min<float>(524288.0f, std::max<float>(0.0f, fRec3[0])));
			float fTemp4 = fVec0[(IOTA0 - iTemp3) & 1048575];
			int iTemp5 = static_cast<int>(std::min<float>(524288.0f, std::max<float>(0.0f, fRec4[0])));
			...
			float fTemp7 = fTemp6 + fSlow2 * fRec5[1];
			...
			output1[i0] = static_cast<FAUSTFLOAT>(fSlow0 * fRec5[0] + fSlow1 * fTemp6);
			IOTA0 = IOTA0 + 1;
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
	...
	#define FAUST_FILE_NAME "smooth_delay.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Interpolation", fHslider3, 1e+01f, 1.0f, 1e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Delay", fHslider2, 1e+02f, 0.0f, 5e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Feedback", fHslider1, 0.0f, 0.0f, 1e+02f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Mix", fHslider0, 5e+01f, 0.0f, 1e+02f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Interpolation, "Interpolation", fHslider3, 1e+01f, 1.0f, 1e+02f, 0.1f) \
		p(HORIZONTALSLIDER, Delay, "Delay", fHslider2, 1e+02f, 0.0f, 5e+03f, 0.1f) \
		p(HORIZONTALSLIDER, Feedback, "Feedback", fHslider1, 0.0f, 0.0f, 1e+02f, 0.1f) \
