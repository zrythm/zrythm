...
struct mydsp : public base_dsp {
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = mydsp_faustpower4_f(fRec3[0]);
			float fTemp2 = fRec4[1] * std::cos(fConst2 * fTemp1 * fTemp0);
			float fTemp3 = mydsp_faustpower3_f(fRec3[0]);
			float fTemp4 = fRec5[1] * std::cos(fConst2 * fTemp3 * fTemp0);
			float fTemp5 = mydsp_faustpower2_f(fRec3[0]);
	...
	FAUST_ADDCHECKBOX("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[0]/Invert Internal Phaser Sum", fCheckbox0);
	FAUST_ADDCHECKBOX("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[0]/Vibrato Mode", fCheckbox1);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[1]/Speed", fHslider1, 0.5f, 0.0f, 1e+01f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[1]/Notch Depth (Intensity)", fHslider0, 1.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[1]/Feedback Gain", fHslider6, 0.0f, -0.999f, 0.999f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Notch width", fHslider5, 1e+03f, 1e+01f, 5e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Min Notch1 Freq", fHslider2, 1e+02f, 2e+01f, 5e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Max Notch1 Freq", fHslider3, 8e+02f, 2e+01f, 1e+04f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Notch Freq Ratio", fHslider4, 1.5f, 1.1f, 4.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[3]/Phaser Output Level", fHslider7, 0.0f, -6e+01f, 1e+01f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(CHECKBOX, Invert_Internal_Phaser_Sum, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[0]/Invert Internal Phaser Sum", fCheckbox0, 0.0f, 0.0f, 1.0f, 1.0f) \
		...
		p(HORIZONTALSLIDER, Speed, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[1]/Speed", fHslider1, 0.5f, 0.0f, 1e+01f, 0.001f) \
		p(HORIZONTALSLIDER, Notch_Depth_(Intensity), "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[1]/Notch Depth (Intensity)", fHslider0, 1.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, Feedback_Gain, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[1]/Feedback Gain", fHslider6, 0.0f, -0.999f, 0.999f, 0.001f) \
		p(HORIZONTALSLIDER, Notch_width, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Notch width", fHslider5, 1e+03f, 1e+01f, 5e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Min_Notch1_Freq, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Min Notch1 Freq", fHslider2, 1e+02f, 2e+01f, 5e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Max_Notch1_Freq, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Max Notch1 Freq", fHslider3, 8e+02f, 2e+01f, 1e+04f, 1.0f) \
		p(HORIZONTALSLIDER, Notch_Freq_Ratio, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[2]/Notch Freq Ratio", fHslider4, 1.5f, 1.1f, 4.0f, 0.001f) \
		p(HORIZONTALSLIDER, Phaser_Output_Level, "PHASER2 [tooltip: Reference:         https://ccrma.stanford.edu/~jos/pasp/Flanging.html]/[3]/Phaser Output Level", fHslider7, 0.0f, -6e+01f, 1e+01f, 0.1f) \
