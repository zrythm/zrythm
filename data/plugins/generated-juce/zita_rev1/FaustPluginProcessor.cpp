...
struct mydsp : public base_dsp {
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow8 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow7) / mydsp_faustpower2_f(fSlow5) + -1.0f));
		...
		float fSlow22 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow21) / mydsp_faustpower2_f(fSlow20) + -1.0f));
		...
		float fSlow31 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow30) / mydsp_faustpower2_f(fSlow29) + -1.0f));
		...
		float fSlow40 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow39) / mydsp_faustpower2_f(fSlow38) + -1.0f));
		...
		float fSlow49 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow48) / mydsp_faustpower2_f(fSlow47) + -1.0f));
		...
		float fSlow58 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow57) / mydsp_faustpower2_f(fSlow56) + -1.0f));
		...
		float fSlow67 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow66) / mydsp_faustpower2_f(fSlow65) + -1.0f));
		...
		float fSlow76 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fSlow75) / mydsp_faustpower2_f(fSlow74) + -1.0f));
	...
	#define FAUST_FILE_NAME "zita_rev1.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Pre-Delay", fHslider5, 2e+01f, 0.0f, 1e+02f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("F1", fHslider3, 2e+02f, 5e+01f, 1e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("F2", fHslider2, 6e+03f, 1.5e+03f, 9.408e+04f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Low RT60", fHslider4, 3.0f, 1.0f, 8.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Mid RT60", fHslider1, 2.0f, 1.0f, 8.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Mix", fHslider0, 5e+01f, 0.0f, 1e+02f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Pre-Delay, "Pre-Delay", fHslider5, 2e+01f, 0.0f, 1e+02f, 1.0f) \
		p(HORIZONTALSLIDER, F1, "F1", fHslider3, 2e+02f, 5e+01f, 1e+03f, 1.0f) \
		p(HORIZONTALSLIDER, F2, "F2", fHslider2, 6e+03f, 1.5e+03f, 9.408e+04f, 1.0f) \
		p(HORIZONTALSLIDER, Low_RT60, "Low RT60", fHslider4, 3.0f, 1.0f, 8.0f, 0.1f) \
		p(HORIZONTALSLIDER, Mid_RT60, "Mid RT60", fHslider1, 2.0f, 1.0f, 8.0f, 0.1f) \
		p(HORIZONTALSLIDER, Mix, "Mix", fHslider0, 5e+01f, 0.0f, 1e+02f, 0.1f) \
