...
struct mydsp : public base_dsp {
	...
	FAUST_ADDHORIZONTALSLIDER("Ratio", fHslider3, 1.0f, 1.0f, 2e+01f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Threshold", fHslider1, -2e+01f, -5e+01f, 0.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Attack", fHslider0, 1e+01f, 1.0f, 2e+02f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Release", fHslider2, 1e+01f, 1.0f, 2e+02f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Mix", fHslider4, 5e+01f, 0.0f, 1e+02f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Ratio, "Ratio", fHslider3, 1.0f, 1.0f, 2e+01f, 0.1f) \
		p(HORIZONTALSLIDER, Threshold, "Threshold", fHslider1, -2e+01f, -5e+01f, 0.0f, 0.1f) \
		p(HORIZONTALSLIDER, Attack, "Attack", fHslider0, 1e+01f, 1.0f, 2e+02f, 1.0f) \
		p(HORIZONTALSLIDER, Release, "Release", fHslider2, 1e+01f, 1.0f, 2e+02f, 1.0f) \
		p(HORIZONTALSLIDER, Mix, "Mix", fHslider4, 5e+01f, 0.0f, 1e+02f, 0.1f) \
