...
struct mydsp : public base_dsp {
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow13 = 1.0f / mydsp_faustpower2_f(fSlow12);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp9 = 1.0f - 1.0f / mydsp_faustpower2_f(fTemp0);
	...
	#define FAUST_FILE_NAME "parametric_eq.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[1] Low Shelf/Low Shelf Gain", fHslider5, 0.0f, -4e+01f, 4e+01f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[1] Low Shelf/Low Shelf Frequency", fHslider4, 2e+02f, 1e+01f, 5e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[2] Peaking Equalizer[tooltip: Parametric Equalizer         sections from filters.lib]/Peak Gain", fHslider2, 0.0f, -4e+01f, 4e+01f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[2] Peaking Equalizer[tooltip: Parametric Equalizer         sections from filters.lib]/Peak Frequency", fHslider1, 7.2e+02f, 2e+01f, 1.6e+04f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[2] Peaking Equalizer[tooltip: Parametric Equalizer         sections from filters.lib]/Peak Q", fHslider3, 1.0f, 1.0f, 2e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[3] High Shelf [tooltip: A high shelf provides a boost         or cut above some frequency]/High Shelf Gain", fHslider6, 0.0f, -4e+01f, 4e+01f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[3] High Shelf [tooltip: A high shelf provides a boost         or cut above some frequency]/High Shelf Frequency", fHslider0, 8e+03f, 2e+01f, 1.8e+04f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Low_Shelf_Gain, "[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[1] Low Shelf/Low Shelf Gain", fHslider5, 0.0f, -4e+01f, 4e+01f, 0.1f) \
		p(HORIZONTALSLIDER, Low_Shelf_Frequency, "[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[1] Low Shelf/Low Shelf Frequency", fHslider4, 2e+02f, 1e+01f, 5e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Peak_Gain, "[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[2] Peaking Equalizer[tooltip: Parametric Equalizer         sections from filters.lib]/Peak Gain", fHslider2, 0.0f, -4e+01f, 4e+01f, 0.1f) \
		p(HORIZONTALSLIDER, Peak_Frequency, "[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[2] Peaking Equalizer[tooltip: Parametric Equalizer         sections from filters.lib]/Peak Frequency", fHslider1, 7.2e+02f, 2e+01f, 1.6e+04f, 1.0f) \
		p(HORIZONTALSLIDER, Peak_Q, "[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[2] Peaking Equalizer[tooltip: Parametric Equalizer         sections from filters.lib]/Peak Q", fHslider3, 1.0f, 1.0f, 2e+01f, 0.01f) \
		p(HORIZONTALSLIDER, High_Shelf_Gain, "[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[3] High Shelf [tooltip: A high shelf provides a boost         or cut above some frequency]/High Shelf Gain", fHslider6, 0.0f, -4e+01f, 4e+01f, 0.1f) \
		p(HORIZONTALSLIDER, High_Shelf_Frequency, "[0] PARAMETRIC EQ SECTIONS [tooltip: See Faust's filters.lib         for info and pointers]/[3] High Shelf [tooltip: A high shelf provides a boost         or cut above some frequency]/High Shelf Frequency", fHslider0, 8e+03f, 2e+01f, 1.8e+04f, 1.0f) \
