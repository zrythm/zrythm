...
struct mydsp : public base_dsp {
	...
	#define FAUST_FILE_NAME "lowpass_filter.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Frequency", fHslider0, 5e+03f, 1e+01f, 1.8e+04f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Frequency, "Frequency", fHslider0, 5e+03f, 1e+01f, 1.8e+04f, 1.0f) \
