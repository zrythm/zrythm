...
struct mydsp : public base_dsp {
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = mydsp_faustpower4_f(fTemp0);
	...
	#define FAUST_FILE_NAME "wah4.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("WAH4 [tooltip: Fourth-order wah effect made using moog_vcf]/Resonance", fHslider0, 2e+02f, 1e+02f, 2e+03f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Resonance, "WAH4 [tooltip: Fourth-order wah effect made using moog_vcf]/Resonance", fHslider0, 2e+02f, 1e+02f, 2e+03f, 1.0f) \
