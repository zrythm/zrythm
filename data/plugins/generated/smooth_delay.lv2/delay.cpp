...
Compilation options: -a /usr/share/faust/lv2.cpp -lang cpp -i -cn delay -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class delay : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /usr/share/faust/lv2.cpp -lang cpp -i -cn delay -es 1 -mcd 16 -single -ftz 0");
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/delay"
#endif
...
struct LV2Plugin {
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (delay**)calloc(ndsps, sizeof(delay*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "delay";
