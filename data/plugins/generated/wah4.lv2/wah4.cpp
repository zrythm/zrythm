...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/wah4"
#endif
...
struct LV2Plugin {
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (wah4**)calloc(ndsps, sizeof(wah4*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "wah4";
