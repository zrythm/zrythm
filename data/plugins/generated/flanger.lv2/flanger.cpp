...
Compilation options: -a /usr/share/faust/lv2.cpp -lang cpp -i -cn flanger -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class flanger : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /usr/share/faust/lv2.cpp -lang cpp -i -cn flanger -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Speed", &fHslider1, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(10.0f), FAUSTFLOAT(0.00999999978f));
		...
		ui_interface->addHorizontalSlider("Feedback", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(-0.999000013f), FAUSTFLOAT(0.999000013f), FAUSTFLOAT(0.00100000005f));
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Flange Delay", &fHslider4, FAUSTFLOAT(10.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fHslider3, "2", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->declare(&fHslider3, "unit", "ms");
		ui_interface->addHorizontalSlider("Delay Offset", &fHslider3, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->closeBox();
		ui_interface->declare(0, "3", "");
		ui_interface->openHorizontalBox("0x00");
		ui_interface->declare(&fHslider0, "unit", "dB");
		ui_interface->addHorizontalSlider("Flanger Output Level", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(10.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec1[0] = (float(1 - iVec0[1]) + fSlow3 * fRec1[1]) - fSlow2 * fRec0[1];
			fHbargraph0 = FAUSTFLOAT(fRec1[0] + fRec0[0]);
			float fTemp0 = fSlow0 * float(input0[i0]);
			float fTemp1 = fSlow4 * fRec2[1] - fTemp0;
			fVec1[IOTA0 & 4095] = fTemp1;
			fRec3[0] = fSlow5 + 0.999000013f * fRec3[1];
			fRec4[0] = fSlow6 + 0.999000013f * fRec4[1];
			float fTemp2 = fRec3[0] + 0.5f * fRec4[0] * (fRec0[0] + 1.0f);
			int iTemp3 = int(fTemp2);
			float fTemp4 = std::floor(fTemp2);
			fRec2[0] = fVec1[(IOTA0 - std::min<int>(2049, std::max<int>(0, iTemp3))) & 4095] * (fTemp4 + 1.0f - fTemp2) + (fTemp2 - fTemp4) * fVec1[(IOTA0 - std::min<int>(2049, std::max<int>(0, iTemp3 + 1))) & 4095];
			output0[i0] = FAUSTFLOAT(0.5f * (fTemp0 + fRec2[0] * fSlow8));
			float fTemp5 = fSlow0 * float(input1[i0]);
			float fTemp6 = fSlow4 * fRec5[1] - fTemp5;
			fVec2[IOTA0 & 4095] = fTemp6;
			float fTemp7 = fRec3[0] + 0.5f * fRec4[0] * (fRec1[0] + 1.0f);
			...
			output1[i0] = FAUSTFLOAT(0.5f * (fTemp5 + fRec5[0] * fSlow8));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			IOTA0 = IOTA0 + 1;
