...
static CURLcode telnet_do(struct connectdata *conn, bool *done)
{
  ...
  WSAEVENT (*create_event_func)(void);
  BOOL (*close_event_func)(WSAEVENT);
  int (*event_select_func)(SOCKET, WSAEVENT, long);
  int (*enum_netevents_func)(SOCKET, WSAEVENT, LPWSANETWORKEVENTS);
...
//  WSOCK2_FUNC enum_netevents_func;
  ...
  */
  ...
  wsock2 = LoadLibrary((LPCSTR) "WS2_32.DLL");
  if(wsock2 == NULL) {
  ...
  create_event_func = (HANDLE (__cdecl *)(void)) GetProcAddress(wsock2,"WSACreateEvent");
  ...
  /* And WSACloseEvent */
  close_event_func = (BOOL (__cdecl *)(HANDLE)) GetProcAddress(wsock2,"WSACloseEvent");
  ...
  /* And WSAEventSelect */
  event_select_func = (int (__cdecl *)(SOCKET,HANDLE,long)) GetProcAddress(wsock2,"WSAEventSelect");
  ...
  enum_netevents_func = (int (__cdecl *)(SOCKET,HANDLE,LPWSANETWORKEVENTS)) GetProcAddress(wsock2,"WSAEnumNetworkEvents");
