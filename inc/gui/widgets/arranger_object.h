...
// Width of fade points on arranger objects
static constexpr int ARRANGER_OBJECT_FADE_POINT_WIDTH = 12;

// Half-width of fade points on arranger objects
static constexpr int ARRANGER_OBJECT_FADE_POINT_HALFWIDTH = 6;
...
arranger_object_is_fade_in (
  ...
  bool                   only_outer)
{
  return arranger_object_is_fade (self, true, x, y, only_handle, only_outer, true)
         || arranger_object_is_fade (
...
arranger_object_is_fade_out (
  ...
  bool                   only_outer)
{
  return arranger_object_is_fade (self, false, x, y, only_handle, only_outer, true)
         || arranger_object_is_fade (
 ...
 */
NONNULL_ARGS (1) OPTIMIZE_O3 bool
