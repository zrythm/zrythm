...
static inline midi_byte_t
midi_get_program_change_number (
  const midi_byte_t short_msg[3])
{
  return short_msg[1];
}
  ...
  const size_t        msg_sz)
{
  g_return_val_if_fail (
    midi_is_meta_event (msg, msg_sz), 0);
