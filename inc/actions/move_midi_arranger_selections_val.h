...
#ifndef __UNDO_MOVE_MIDI_ARRANGER_SELECTIONS_VAL_ACTION_H__
#define __UNDO_MOVE_MIDI_ARRANGER_SELECTIONS_VAL_ACTION_H__

#include "actions/undoable_action.h"


typedef struct MoveMidiArrangerSelectionsValAction
{
