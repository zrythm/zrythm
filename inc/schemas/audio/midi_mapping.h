...
{
  YAML_FIELD_INT (
    MidiMapping_v1, schema_version),
  YAML_FIELD_FIXED_SIZE_PTR_ARRAY (
    MidiMapping_v1, key,
    uint8_t_schema, 3),
  YAML_FIELD_MAPPING_PTR_OPTIONAL (
    MidiMapping_v1, device_port,
    ext_port_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
    MidiMapping_v1, dest_id,
    port_identifier_fields_schema_v1),
  YAML_FIELD_INT (
    MidiMapping_v1, enabled),
...
midi_mappings_fields_schema_v1[] =
{
  YAML_FIELD_FIXED_SIZE_PTR_ARRAY_VAR_COUNT (
    MidiMappings_v1, mappings, midi_mapping_schema_v1),

  CYAML_FIELD_END
};

static const cyaml_schema_value_t
midi_mappings_schema_v1 =
{
  YAML_VALUE_PTR (
    MidiMappings_v1, midi_mappings_fields_schema_v1),
};
