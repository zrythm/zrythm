...
{
  YAML_FIELD_INT (
    TimeSignature_v1, schema_version),
  YAML_FIELD_INT (
    TimeSignature_v1, beats_per_bar),
  YAML_FIELD_INT (
    TimeSignature_v1, beat_unit),
...
{
  YAML_VALUE_PTR (
    TimeSignature_v1, time_signature_fields_schema_v1),
};
...
{
  YAML_FIELD_INT (
    Transport_v1, schema_version),
  YAML_FIELD_INT (
    Transport_v1, total_bars),
  YAML_FIELD_MAPPING_EMBEDDED (
    Transport_v1, playhead_pos,
    position_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
    Transport_v1, cue_pos,
    position_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
    Transport_v1, loop_start_pos,
    position_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
    Transport_v1, loop_end_pos,
    position_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
    Transport_v1, punch_in_pos,
    position_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
    Transport_v1, punch_out_pos,
    position_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
  ...
  YAML_FIELD_INT (
    Transport_v1, has_range),
  YAML_FIELD_MAPPING_EMBEDDED (
    Transport_v1, time_sig,
    time_signature_fields_schema_v1),
  YAML_FIELD_INT (
    Transport_v1, position),
