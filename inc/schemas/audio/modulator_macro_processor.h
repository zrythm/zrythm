...
{
  YAML_FIELD_INT (
    ModulatorMacroProcessor_v1, schema_version),
  YAML_FIELD_STRING_PTR (
    ModulatorMacroProcessor_v1, name),
  YAML_FIELD_MAPPING_PTR (
    ModulatorMacroProcessor_v1, cv_in,
    port_fields_schema_v1),
  YAML_FIELD_MAPPING_PTR (
    ModulatorMacroProcessor_v1, cv_out,
    port_fields_schema_v1),
  YAML_FIELD_MAPPING_PTR (
    ModulatorMacroProcessor_v1, macro,
    port_fields_schema_v1),
