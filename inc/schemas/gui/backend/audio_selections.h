  ...
  audio_selections_fields_schema_v1[] =
{
  YAML_FIELD_MAPPING_EMBEDDED (
    AudioSelections_v1, base,
    arranger_selections_fields_schema_v1),
  YAML_FIELD_INT (
    AudioSelections_v1, schema_version),
  YAML_FIELD_INT (
    AudioSelections_v1, has_selection),
  YAML_FIELD_MAPPING_EMBEDDED (
    AudioSelections_v1, sel_start,
    position_fields_schema_v1),
  YAML_FIELD_MAPPING_EMBEDDED (
    AudioSelections, sel_end,
    position_fields_schema_v1),
  YAML_FIELD_INT (
    AudioSelections_v1, pool_id),
  YAML_FIELD_MAPPING_EMBEDDED (
    AudioSelections_v1, region_id,
