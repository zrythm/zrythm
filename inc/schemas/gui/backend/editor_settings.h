...
{
  YAML_FIELD_INT (
    EditorSettings_v1, schema_version),
  YAML_FIELD_INT (
    EditorSettings_v1, scroll_start_x),
  YAML_FIELD_INT (
    EditorSettings_v1, scroll_start_y),
  YAML_FIELD_FLOAT (
    EditorSettings_v1, hzoom_level),

  CYAML_FIELD_END
};

static const cyaml_schema_value_t
editor_settings_schema_v1 =
{
  YAML_VALUE_PTR (
    EditorSettings_v1,
    editor_settings_fields_schema_v1),
