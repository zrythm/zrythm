...
{
  int              schema_version;
  Plugin_v2 *      midi_fx[STRIP_SIZE];
  Plugin_v2 *      inserts[STRIP_SIZE];
  Plugin_v2 *      instrument;
  ChannelSend_v1 * sends[STRIP_SIZE];
  ExtPort_v1 *     ext_midi_ins[EXT_PORTS_MAX];
  int              num_ext_midi_ins;
  int              all_midi_ins;
...
static const cyaml_schema_field_t channel_fields_schema_v2[] = {
  ...
  YAML_FIELD_SEQUENCE_FIXED (Channel_v2, midi_fx, plugin_schema_v2, STRIP_SIZE),
  YAML_FIELD_SEQUENCE_FIXED (Channel_v2, inserts, plugin_schema_v2, STRIP_SIZE),
  YAML_FIELD_SEQUENCE_FIXED (Channel_v2, sends, channel_send_schema_v1, STRIP_SIZE),
  YAML_FIELD_MAPPING_PTR_OPTIONAL (Channel_v2, instrument, plugin_fields_schema_v2),
  YAML_FIELD_MAPPING_PTR (Channel_v2, prefader, fader_fields_schema_v1),
  YAML_FIELD_MAPPING_PTR (Channel_v2, fader, fader_fields_schema_v1),
