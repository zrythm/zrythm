...
{
  YAML_FIELD_INT (
    PluginDescriptor_v1, schema_version),
  YAML_FIELD_STRING_PTR_OPTIONAL (
    PluginDescriptor_v1, author),
  YAML_FIELD_STRING_PTR_OPTIONAL (
    PluginDescriptor_v1, name),
  YAML_FIELD_STRING_PTR_OPTIONAL (
    PluginDescriptor_v1, website),
  YAML_FIELD_ENUM (
    PluginDescriptor_v1, category,
    plugin_descriptor_category_strings_v1),
  YAML_FIELD_STRING_PTR_OPTIONAL (
    PluginDescriptor_v1, category_str),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_audio_ins),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_audio_outs),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_midi_ins),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_midi_outs),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_ctrl_ins),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_ctrl_outs),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_cv_ins),
  YAML_FIELD_UINT (
    PluginDescriptor_v1, unique_id),
  YAML_FIELD_INT (
    PluginDescriptor_v1, num_cv_outs),
  YAML_FIELD_ENUM (
    PluginDescriptor_v1, arch,
    plugin_architecture_strings_v1),
  YAML_FIELD_ENUM (
    PluginDescriptor_v1, protocol,
    plugin_protocol_strings_v1),
  YAML_FIELD_STRING_PTR_OPTIONAL (
    PluginDescriptor_v1, path),
  YAML_FIELD_STRING_PTR_OPTIONAL (
    PluginDescriptor_v1, uri),
  YAML_FIELD_UINT (
    PluginDescriptor_v1, ghash),
