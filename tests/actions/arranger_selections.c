...
test_move_audio_region_and_lower_bpm (void)
{
  ...
  track_create_with_action (
    TRACK_TYPE_AUDIO, NULL, file, &pos, track_pos, 1, -1, NULL, NULL);
...
test_duplicate_automation_region (void)
{
  ...
  arranger_selections_action_perform_edit (
    ...
    ARRANGER_SELECTIONS_ACTION_EDIT_PRIMITIVE, F_ALREADY_EDITED, NULL);
...
test_edit_marker (void)
{
  ...
  arranger_selections_action_perform_edit (
    ...
    ARRANGER_SELECTIONS_ACTION_EDIT_NAME, F_NOT_ALREADY_EDITED, NULL);
...
test_mute (void)
{
  ...
  arranger_selections_action_perform_edit (
    ...
    ARRANGER_SELECTIONS_ACTION_EDIT_MUTE, F_NOT_ALREADY_EDITED, NULL);
...
test_split_large_audio_file (void)
{
  ...
  Track * track = track_new (
    TRACK_TYPE_AUDIO, TRACKLIST->num_tracks, "test track", F_WITH_LANE);
  ...
  ZRegion * r = audio_region_new (
    -1, TEST_SINE_OGG_30MIN, true, NULL, 0, NULL, 0, 0, &pos, track_name_hash,
...
test_audio_functions (void)
{
  ...
  arranger_selections_action_perform_edit_audio_function (
    (ArrangerSelections *) AUDIO_SELECTIONS, AUDIO_FUNCTION_INVERT, opts, NULL,
    NULL);
...
test_duplicate_audio_regions (void)
{
  ...
  SupportedFile * file = supported_file_new_from_path (audio_file_path);
  track_create_with_action (
    TRACK_TYPE_AUDIO, NULL, file, &pos1, track_pos, 1, -1, NULL, NULL);
  Track * track = tracklist_get_track (TRACKLIST, track_pos);
...
test_move_region_from_lane_3_to_lane_1 (void)
{
  ...
  position_init (&pos);
  track_create_with_action (
    TRACK_TYPE_MIDI, NULL, NULL, &pos, TRACKLIST->num_tracks, 1, -1, NULL, NULL);
  Track * track =
    tracklist_get_last_track (TRACKLIST, TRACKLIST_PIN_OPTION_BOTH, false);
  ...
  track = tracklist_get_last_track (TRACKLIST, TRACKLIST_PIN_OPTION_BOTH, true);
