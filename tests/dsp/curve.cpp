...
test_curve_algorithms (void)
{
  ...
  opts.algo = CurveAlgorithm::EXPONENT;
  ...
  opts.algo = CurveAlgorithm::SUPERELLIPSE;
  ...
  opts.algo = CurveAlgorithm::VITAL;
  ...
  opts.algo = CurveAlgorithm::PULSE;
  ...
  opts.algo = CurveAlgorithm::LOGARITHMIC;
