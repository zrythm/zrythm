...
# Run QML linting (auto-generated by qt_add_qml_module; all QML modules)
cmake --build conanbuild/Debug --target all_qmllint

# Lint a single QML module (faster while iterating)
