...
Transport::Transport (AudioEngine * engine) : audio_engine_ (engine)
{
  ...
  roll_->id_.sym_ = ("roll");
  roll_->set_owner (PortIdentifier::OwnerType::Transport, this);
  ...
  stop_->id_.sym_ = ("stop");
  stop_->set_owner (PortIdentifier::OwnerType::Transport, this);
  ...
  backward_->set_owner (PortIdentifier::OwnerType::Transport, this);
  ...
  forward_->set_owner (PortIdentifier::OwnerType::Transport, this);
  ...
  loop_toggle_->set_owner (PortIdentifier::OwnerType::Transport, this);
  ...
  rec_toggle_->set_owner (PortIdentifier::OwnerType::Transport, this);
