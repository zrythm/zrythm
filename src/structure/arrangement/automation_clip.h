...
private:
  ...
  friend void to_json (nlohmann::json &j, const AutomationClip &clip);
  friend void from_json (const nlohmann::json &j, AutomationClip &clip);

private:
  BOOST_DESCRIBE_CLASS (
    AutomationClip,
    (Clip, ArrangerObjectOwner<AutomationPoint>),
    (),
    (),
    ())
};
