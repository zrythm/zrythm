...
public:
  ...
  BOOST_DESCRIBE_CLASS (
    Region,
    (TimelineObject, NamedObject, MuteableObject, LoopableObject, ColoredObject),
    (link_group_),
    (),
    ())
};
...
private:
  ...
  BOOST_DESCRIBE_CLASS (RegionImpl<RegionT>, (Region), (), (), ())
};
...
DEFINE_ENUM_FORMATTER (
  zrythm::structure::arrangement::MusicalMode,
  MusicalMode,
...
DEFINE_OBJECT_FORMATTER (
  zrythm::structure::arrangement::Region,
  Region,
  [] (const auto &r) {
    return fmt::format (
      "Region[id: {}, name: {}, "
