...
#ifndef gdk_quartz_event_get_nsevent
NSEvent  *gdk_quartz_event_get_nsevent                          (GdkEvent       *event);
#endif
#ifndef gdk_quartz_window_get_nsview
...
suil_cocoa_realize(GtkWidget* widget)
{
  ...
  GdkWindow * parent_gdk_win =
    gtk_widget_get_parent_window (
      widget);
	GdkWindow * gdk_window = gdk_window_new(
		parent_gdk_win,
		&attrs,
...
static gboolean
suil_cocoa_draw(GtkWidget* widget, cairo_t * cr)
{
	SuilCocoaWrapper* const self = SUIL_COCOA_WRAPPER(widget);
	NSView*                 view = (NSView*)self->instance->ui_widget;
  GtkAllocation allocation;
...
suil_cocoa_wrapper_class_init(SuilCocoaWrapperClass* klass)
{
  ...
  /* replaced with draw */
  widget_class->draw = suil_cocoa_draw;
	// FIXME widget_class->size_request = suil_cocoa_size_request;
...
SuilWrapper*
suil_wrapper_new_cocoa (SuilHost*      host,
