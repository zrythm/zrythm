  ...
  GError **         error)
{
  ...
  if (group->ids_size > 0)
    {
      group->ids = g_malloc0_n (group->ids_size, sizeof (RegionIdentifier));
  ...
  if (groups_arr)
    {
      ...
      if (mgr->groups_size > 0)
        {
          mgr->groups =
            g_malloc0_n (mgr->groups_size, sizeof (RegionLinkGroup *));
  ...
  GError **      error)
{
  ...
  if (mm->mappings_size > 0)
    {
      mm->mappings = g_malloc0_n (mm->mappings_size, sizeof (MidiMapping *));
  ...
  if (as_actions_arr)
    {
      ...
      if (stack->as_actions_size > 0)
        {
          stack->as_actions = g_malloc0_n (
            stack->as_actions_size, sizeof (ArrangerSelectionsAction *));
  ...
  if (mixer_selections_actions_arr)
    {
      ...
      if (stack->mixer_selections_actions_size > 0)
        {
          stack->mixer_selections_actions = g_malloc0_n (
            stack->mixer_selections_actions_size,
            sizeof (MixerSelectionsAction *));
  ...
  if (tracklist_selections_actions_arr)
    {
      ...
      if (stack->tracklist_selections_actions_size > 0)
        {
          stack->tracklist_selections_actions = g_malloc0_n (
            stack->tracklist_selections_actions_size,
            sizeof (TracklistSelectionsAction *));
  ...
  if (channel_send_actions_arr)
    {
      ...
      if (stack->channel_send_actions_size > 0)
        {
          stack->channel_send_actions = g_malloc0_n (
            stack->channel_send_actions_size, sizeof (ChannelSendAction *));
  ...
  if (port_connection_actions_arr)
    {
      ...
      if (stack->port_connection_actions_size > 0)
        {
          stack->port_connection_actions = g_malloc0_n (
            stack->port_connection_actions_size,
            sizeof (PortConnectionAction *));
  ...
  if (port_actions_arr)
    {
      ...
      if (stack->port_actions_size > 0)
        {
          stack->port_actions =
            g_malloc0_n (stack->port_actions_size, sizeof (PortAction *));
  ...
  if (midi_mapping_actions_arr)
    {
      ...
      if (stack->midi_mapping_actions_size > 0)
        {
          stack->midi_mapping_actions = g_malloc0_n (
            stack->midi_mapping_actions_size, sizeof (MidiMappingAction *));
  ...
  if (range_actions_arr)
    {
      ...
      if (stack->range_actions_size > 0)
        {
          stack->range_actions =
            g_malloc0_n (stack->range_actions_size, sizeof (RangeAction *));
  ...
  if (transport_actions_arr)
    {
      ...
      if (stack->transport_actions_size > 0)
        {
          stack->transport_actions = g_malloc0_n (
            stack->transport_actions_size, sizeof (TransportAction *));
  ...
  if (chord_actions_arr)
    {
      ...
      if (stack->chord_actions_size > 0)
        {
          stack->chord_actions =
            g_malloc0_n (stack->chord_actions_size, sizeof (ChordAction *));
