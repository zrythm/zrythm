  ...
  GError **         error)
{
  ...
  yyjson_mut_obj_add_int (
    doc, pr_obj, "midiModifier", (int64_t) pr->midi_modifier);
...
snap_grid_serialize_to_json (
  ...
  GError **        error)
{
  yyjson_mut_obj_add_int (doc, sg_obj, "type", (int64_t) sg->type);
  yyjson_mut_obj_add_int (
    doc, sg_obj, "snapNoteLength", (int64_t) sg->snap_note_length);
  yyjson_mut_obj_add_int (
    doc, sg_obj, "snapNoteType", (int64_t) sg->snap_note_type);
  yyjson_mut_obj_add_bool (doc, sg_obj, "snapAdaptive", sg->snap_adaptive);
  yyjson_mut_obj_add_int (
    doc, sg_obj, "defaultNoteLength", (int64_t) sg->default_note_length);
  yyjson_mut_obj_add_int (
    doc, sg_obj, "defaultNoteType", (int64_t) sg->default_note_type);
  yyjson_mut_obj_add_bool (doc, sg_obj, "defaultAdaptive", sg->default_adaptive);
  yyjson_mut_obj_add_int (doc, sg_obj, "lengthType", (int64_t) sg->length_type);
...
quantize_options_serialize_to_json (
  ...
  GError **               error)
{
  yyjson_mut_obj_add_int (doc, qo_obj, "noteLength", (int64_t) qo->note_length);
  yyjson_mut_obj_add_int (doc, qo_obj, "noteType", (int64_t) qo->note_type);
