  ...
  GError **               error)
{
  ...
  yyjson_mut_obj_add_int (
    doc, descr_obj, "rootNote", (int64_t) descr->root_note);
  yyjson_mut_obj_add_int (
    doc, descr_obj, "bassNote", (int64_t) descr->bass_note);
  yyjson_mut_obj_add_int (doc, descr_obj, "type", (int64_t) descr->type);
  yyjson_mut_obj_add_int (doc, descr_obj, "accent", (int64_t) descr->accent);
