...
bot_dock_edge_widget_setup (BotDockEdgeWidget * self)
{
  event_viewer_widget_setup (
    self->event_viewer_midi, EventViewerType::EVENT_VIEWER_TYPE_MIDI);
  event_viewer_widget_setup (
    self->event_viewer_audio, EventViewerType::EVENT_VIEWER_TYPE_AUDIO);
  event_viewer_widget_setup (
    self->event_viewer_chord, EventViewerType::EVENT_VIEWER_TYPE_CHORD);
  event_viewer_widget_setup (
    self->event_viewer_automation,
    EventViewerType::EVENT_VIEWER_TYPE_AUTOMATION);
