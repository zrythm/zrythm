...
#include "gui/backend/backend/cyaml_schemas/gui/backend/audio_clip_editor.h"
#include "gui/backend/backend/cyaml_schemas/gui/backend/automation_editor.h"
#include "gui/backend/backend/cyaml_schemas/gui/backend/chord_editor.h"
#include "gui/backend/backend/cyaml_schemas/gui/backend/piano_roll.h"
