...
{
  g_settings_set_enum (
    S_UI, "bounce-step", BOUNCE_STEP_PRE_FADER);
...
{
  g_settings_set_enum (
    S_UI, "bounce-step", BOUNCE_STEP_POST_FADER);
...
static void
bounce_step_selector_widget_class_init (
  BounceStepSelectorWidgetClass * _klass)
{
#if 0
