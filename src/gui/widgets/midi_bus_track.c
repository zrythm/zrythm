...
G_DEFINE_TYPE (MidiBusTrackWidget,
...
void
midi_bus_track_widget_refresh (MidiBusTrackWidget * self)
{
  TRACK_WIDGET_GET_PRIVATE (self);
  ...
  midi_bus_track_widget_refresh_buttons (self);
...
static void
midi_bus_track_widget_init (MidiBusTrackWidget * self)
{
...
static void
midi_bus_track_widget_class_init (MidiBusTrackWidgetClass * klass)
{
}
