...
bot_dock_edge_widget_setup (BotDockEdgeWidget * self)
{
  ...
  event_viewer_widget_setup (
    self->event_viewer_audio, EVENT_VIEWER_TYPE_AUDIO);
  event_viewer_widget_setup (
    self->event_viewer_chord, EVENT_VIEWER_TYPE_CHORD);
  event_viewer_widget_setup (
  ...
  gtk_widget_set_visible (
    GTK_WIDGET (self->event_viewer_stack), visibility);
...
bot_dock_edge_widget_init (BotDockEdgeWidget * self)
{
  ...
  gtk_stack_add_named (
    self->event_viewer_stack,
    GTK_WIDGET (self->event_viewer_automation), "automation");
...
#define ADD_TAB(widget, icon, title) \
  ...
  ADD_TAB (
    self->clip_editor_box, "piano-roll", _ ("Editor view"));
  ADD_TAB (self->mixer_box, "mixer", _ ("Mixer view"));
  ADD_TAB (
    self->modulator_view_box, "modulator", _ ("Modulators"));
  ADD_TAB (
    self->chord_pad_panel_box, "chord-pad", _ ("Chord pad"));
