...
G_DEFINE_TYPE (MidiGroupTrackWidget,
...
midi_group_track_widget_refresh (MidiGroupTrackWidget * self)
{
  ...
  midi_group_track_widget_refresh_buttons (self);
...
static void
midi_group_track_widget_init (MidiGroupTrackWidget * self)
{
...
static void
midi_group_track_widget_class_init (MidiGroupTrackWidgetClass * klass)
{
}
