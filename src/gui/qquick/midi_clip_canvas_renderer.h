...
class MidiClipCanvasItem;

class MidiClipCanvasRenderer : public QCanvasPainterItemRenderer
{
public:
  MidiClipCanvasRenderer () = default;
  Q_DISABLE_COPY_MOVE (MidiClipCanvasRenderer)
