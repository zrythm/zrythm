...
#define UNMOVE_TRANSPORT_MARKERS \
  UNMOVE_TRANSPORT_MARKER (playhead_pos); \
  UNMOVE_TRANSPORT_MARKER (cue_pos); \
  UNMOVE_TRANSPORT_MARKER (loop_start_pos); \
  UNMOVE_TRANSPORT_MARKER (loop_end_pos)
