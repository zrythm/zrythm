...
MOODYCAMEL_EXPORT int moodycamel_cq_create(MoodycamelCQHandle* handle, size_t capacity);
...
MOODYCAMEL_EXPORT int moodycamel_cq_try_enqueue_producer(MoodycamelCQHandle handle, void * token, MoodycamelValue value);
MOODYCAMEL_EXPORT int moodycamel_cq_try_dequeue_consumer(MoodycamelCQHandle handle, void * token, MoodycamelValue* value);
MOODYCAMEL_EXPORT size_t moodycamel_cq_size_approx(MoodycamelCQHandle handle);
MOODYCAMEL_EXPORT void * moodycamel_create_producer_token(MoodycamelCQHandle handle);
MOODYCAMEL_EXPORT void * moodycamel_create_consumer_token(MoodycamelCQHandle handle);
